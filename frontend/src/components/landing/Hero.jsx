        ...
        >
          <div className="relative h-[330px] w-[300px] sm:h-[370px] sm:w-[340px] md:h-[390px] md:w-[350px] lg:h-[500px] lg:w-[450px]">
            ...
            <img
              ...
              className="absolute left-1/2 top-5 h-[180px] w-[100%] -translate-x-1/2 rounded-xl object-cover shadow-lg sm:top-6 sm:h-[230px] sm:rounded-2xl md:h-[240px] lg:top-8 lg:h-[315px]"
            />
